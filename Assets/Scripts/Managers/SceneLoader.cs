        ...
        private void ShowLoadingScreen()
        {
            if (_loadingScreenPrefab != null)
            {
                ...
                if (_progressBar == null)
                    _progressBar = _currentLoadingScreen.GetComponentInChildren<UnityEngine.UI.Slider>();
                
                if (_progressText == null)
                    _progressText = _currentLoadingScreen.GetComponentInChildren<TMPro.TextMeshProUGUI>();
            }
