...
public class PlayerStats : MonoBehaviour
{
    ...
    [SerializeField] private float currentHealth = 80f;
    ...
    [SerializeField] private float moveSpeedInAir = 5f;
    ...
    private bool isAppliedHurt = false;
    ...
    private void Awake() { immuneTimer = 0f; isShielding = false; }
    private void Update() { UpdateImmuneTimer(); UpdateUI(); }
    private void UpdateImmuneTimer() { if (immuneTimer > 0f) { immuneTimer = Mathf.Max(0f, immuneTimer - Time.deltaTime); } }
    private void UpdateUI() { if (healthBar != null) UpdateHealthSlider(); if (staminaBar != null) UpdateStaminaSlider(); }
    ...
    {
        if (immuneTimer > 0f || isShielding || damageAmount <= 0f) return;
